...
export function world_add_entity(a: number, b: number, c: number, d: number, e: number): void;
export function world_get_entity_len(a: number): number;
export function world_get_entity(a: number, b: number, c: number): number;
