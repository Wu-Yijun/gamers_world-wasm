...
export function enemies_add_enemy(a: number, b: number, c: number, d: number, e: number, f: number): void;
...
export function __wbg_get_enemy_max_hp(a: number): number;
export function __wbg_set_enemy_max_hp(a: number, b: number): void;
export function __wbg_get_enemy_sp(a: number): number;
export function __wbg_set_enemy_sp(a: number, b: number): void;
export function __wbg_get_enemy_max_sp(a: number): number;
export function __wbg_set_enemy_max_sp(a: number, b: number): void;
...
export function enemy_attack(a: number): number;
